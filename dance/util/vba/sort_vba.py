...
if __name__ == '__main__':
  ...
  parser.add_argument('-x','--index_file', type=argparse.FileType('w',encoding='UTF-8'),default='docs/functions/vba_index.md',help='provide the name of the index documentation file')
  parser.add_argument('-s','--sorted_file', type=argparse.FileType('w',encoding='UTF-8'),default='docs/functions/vba_sorted.md',help='provide the name of the sorted code documentation file')
