...
from dance.util.balance_check import balance_test_pairs
from tests.iande_check import iande_test_pairs
from dance.util.helpers import get_row_set
...
# I and E
  ...
  if test_group in test_groups:
    ...
    test_lines={
      'tbl_invest_actl': keys,
      'tbl_iande': ['Income:I:Invest income:CapGn:Mut LT','Income:I:Invest income:CapGn:Mut ST',
                    'Income:I:Invest income:Div:Reg','Income:I:Invest income:Div:Tax-exempt',
                    'Income:I:Invest income:Int:Defered-tax','Income:I:Invest income:Int:Reg',
                    'Income:I:Invest income:Int:Tax-exempt','Income:I:Invest income:Int:Tax-exempt Muni Accrued Int Paid']
    }
